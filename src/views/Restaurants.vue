...
export default {
  ...
  methods: {
    ...
    addParams: function() {
      ...
      axios.get("/api/restaurants?address=" + this.address + "&keyword=" + this.cuisine +"&minprice=" + this.min_price + "&maxprice=" + this.max_price +"&distance=" + this.radius * 1609.34).then(response => {
